	...
	namespace Linphone
	{
		namespace Native
		{
			...
			public:
				...
				/// </summary>
				static property LogCollectionState LogCollectionEnabled
				{
					LogCollectionState get();
					void set(LogCollectionState value);
				}
				...
				property Windows::Foundation::Collections::IVector<PayloadType^>^ AudioCodecs
				{
					Windows::Foundation::Collections::IVector<PayloadType^>^ get();
				}
				...
				property Windows::Foundation::Collections::IVector<AuthInfo^>^ AuthInfoList
				{
					Windows::Foundation::Collections::IVector<AuthInfo^>^ get();
				}
				...
				property Windows::Foundation::Collections::IVector<CallLog^>^ CallLogs
				{
					Windows::Foundation::Collections::IVector<CallLog^>^ get();
				}

				/// <summary>
				/// Gets the current list of calls.
				/// </summary>
				property Windows::Foundation::Collections::IVector<Call^>^ Calls
				{
					Windows::Foundation::Collections::IVector<Call^>^ get();
				}
				...
				/// </summary>
				property Windows::Foundation::Collections::IVector<ChatRoom^>^ ChatRooms
				{
					Windows::Foundation::Collections::IVector<ChatRoom^>^ get();
				}
				...
				/// </summary>
				property CoreListener^ CoreListener
				{
					BelledonneCommunications::Linphone::Native::CoreListener^ get();
					void set(BelledonneCommunications::Linphone::Native::CoreListener^ listener);
				}
				...
				/// </summary>
				property FirewallPolicy FirewallPolicy
				{
					BelledonneCommunications::Linphone::Native::FirewallPolicy get();
					void set(BelledonneCommunications::Linphone::Native::FirewallPolicy value);
				}
				...
				/// </summary>
				property VideoSize^ PreferredVideoSize
				{
					VideoSize^ get();
					void set(VideoSize^ value);
				}
				...
				/// </summary>
				property Windows::Foundation::Collections::IVector<ProxyConfig^>^ ProxyConfigList
				{
					Windows::Foundation::Collections::IVector<ProxyConfig^>^ get();
				}
				...
				/// </summary>
				property Windows::Foundation::Collections::IVector<VideoSize^>^ SupportedVideoSizes
				{
					Windows::Foundation::Collections::IVector<VideoSize^>^ get();
				}
				...
				{
					BelledonneCommunications::Linphone::Native::Tunnel^ get();
				}
				...
				/// </summary>
				property Windows::Foundation::Collections::IVector<PayloadType^>^ VideoCodecs
				{
					Windows::Foundation::Collections::IVector<PayloadType^>^ get();
				}
				...
				/// </summary>
				property VideoPolicy^ VideoPolicy
				{
					BelledonneCommunications::Linphone::Native::VideoPolicy^ get();
				...
				/// </summary>
				/// <param name="uri">The URI from which to create a Address</param>
				...
				ChatRoom^ GetChatRoomFromUri(Platform::String^ to);
