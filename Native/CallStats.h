...
namespace Linphone
{
	namespace Native
	{
		...
		public:
			...
			/// </summary>
			property Linphone::Native::IceState IceState
			{
				Linphone::Native::IceState get();
			}
			...
			/// </summary>
			property Linphone::Native::MediaType MediaType
			{
				Linphone::Native::MediaType get();
			}
		...
		private:
			...
			CallStats(::LinphoneCall *call, Linphone::Native::MediaType mediaType);
			...
			::LinphoneCall *call;
			Linphone::Native::MediaType mediaType;
			Linphone::Native::IceState iceState;
