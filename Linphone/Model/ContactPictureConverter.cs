...
namespace Linphone.Model
{
    ...
    /// Converter to get contacts' images without having to call Contact object methods
    /// </summary>
    public class LinphoneContactPictureConverter : System.Windows.Data.IValueConverter
    {
        /// <summary>
        /// Converts the picture of a contact (an ImageStream) into an Image object.
        /// </summary>
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            LinphoneContact c = value as LinphoneContact;
            if (c == null)
                return null;

            Stream imgStream = c.Contact.GetPicture();
            if (imgStream != null)
                return PictureDecoder.DecodeJpeg(imgStream);
