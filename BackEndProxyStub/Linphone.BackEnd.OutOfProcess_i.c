...
MIDL_DEFINE_GUID(IID, IID___x_ABI_CLinphone_CBackEnd_COutOfProcess_C____IServerPublicNonVirtuals,0xEBDEF036,0x447F,0x3D47,0xB3,0x3F,0x71,0x50,0x68,0xAC,0xD4,0xCC);
