...

	{
...

		{
...

			{
				...
				return linphone_nat_policy_upnp_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_nat_policy_turn_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_nat_policy_stun_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_nat_policy_ice_enabled(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_video_activation_policy_get_automatically_accept(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_video_activation_policy_get_automatically_initiate(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_call_echo_limiter_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_call_get_authentication_token_verified(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_call_camera_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_call_echo_cancellation_enabled(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_tunnel_sip_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_tunnel_dual_mode_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_tunnel_get_activated(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_vcard_get_skip_validation(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_core_is_incoming_invite_pending(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_video_display_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_get_use_rfc2833_for_dtmf(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_get_use_files(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_chat_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_video_multicast_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_echo_limiter_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_is_network_reachable(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_video_capture_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_dns_srv_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_realtime_text_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_echo_cancellation_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_is_media_encryption_mandatory(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_video_preview_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_is_in_conference(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_video_adaptive_jittcomp_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_adaptive_rate_control_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_get_ring_during_incoming_early_media(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_mic_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_sdp_200_ack_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_audio_multicast_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_video_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_audio_adaptive_jittcomp_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_self_view_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_keep_alive_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_dns_search_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_get_guess_hostname(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_get_use_info_for_dtmf(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_core_ipv6_enabled(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_buffer_is_empty(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_friend_list_subscriptions_enabled(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_address_get_secure(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_address_is_sip(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_proxy_config_publish_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_proxy_config_get_dial_escape_plus(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_proxy_config_avpf_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_proxy_config_quality_reporting_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_proxy_config_register_enabled(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_chat_room_is_remote_composing(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_chat_message_get_to_be_stored(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_chat_message_is_secured(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_chat_message_is_file_transfer(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_chat_message_is_text(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_chat_message_is_read(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_chat_message_is_outgoing(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_presence_model_is_online(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_payload_type_is_vbr(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_payload_type_is_usable(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_call_log_video_enabled(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_im_notif_policy_get_recv_imdn_displayed(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_im_notif_policy_get_send_imdn_displayed(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_im_notif_policy_get_send_is_composing(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_im_notif_policy_get_recv_imdn_delivered(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_im_notif_policy_get_recv_is_composing(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_im_notif_policy_get_send_imdn_delivered(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_video_definition_is_undefined(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_content_is_multipart(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_call_params_video_multicast_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_call_params_get_local_conference_mode(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_call_params_early_media_sending_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_call_params_audio_multicast_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_call_params_video_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_call_params_audio_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_call_params_low_bandwidth_enabled(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_call_params_realtime_text_enabled(nativePtr) == 1;
...

	{
...

		{
...

			{
				...
				return linphone_friend_is_presence_received(nativePtr) == 1;
...

		{
...

			{
				...
				return linphone_friend_subscribes_enabled(nativePtr) == 1;
